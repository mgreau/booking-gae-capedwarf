...
<ul>
	<li>Get hotel : <a
		href="http://localhost:8080/_ah/api/bookingendpoint/v1/hotel/1">http://localhost:8080/_ah/api/bookingendpoint/v1/hotel/1</a></li>
	...
	<li>Search hotels : <a
		href="http://localhost:8080/_ah/api/bookingendpoint/v1/searchHotel/price=5">http://localhost:8080/_ah/api/bookingendpoint/v1/searchHotel/price=5</a></li>
</ul>
